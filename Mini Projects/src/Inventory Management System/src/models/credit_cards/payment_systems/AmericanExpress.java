...
public class AmericanExpress extends AbstractCard implements AmericanExpressInterface {
    ...
    public AmericanExpress(String firstName, String lastName, String email, String cardNumber, String expiryDate, String ccv, String paymentSystem, double amount) {
        super(firstName, lastName, email, cardNumber, expiryDate, ccv, amount);
