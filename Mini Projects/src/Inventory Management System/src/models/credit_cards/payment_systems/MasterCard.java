...
public class MasterCard extends AbstractCard implements MasterCardInterface {
    ...
    public MasterCard(String firstName, String lastName, String email, String cardNumber, String expiryDate, String cvv, String cardType, double amount) {
        super(firstName, lastName, email, cardNumber, expiryDate, cvv, amount);
