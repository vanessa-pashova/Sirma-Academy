...
public class MasterCard extends AbstractCard implements MasterCardInterface {
    ...
    public MasterCard(String firstName, String lastName, String cardNumber, String expiryDate, String cvv, String cardType) {
        super(firstName, lastName, cardNumber, expiryDate, cvv);
